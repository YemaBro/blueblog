...
from flask import Blueprint, render_template, redirect, url_for, request, current_app, flash, send_from_directory
...
def manage_post():
    ...
    return render_template('admin/manage_post.html', pagination=pagination, page=page, posts=posts)
